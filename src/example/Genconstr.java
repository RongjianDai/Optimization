package example;/* Copyright 2017, Gurobi Optimization, Inc. */
...
public class Genconstr {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // Create environment
      GRBEnv env = new GRBEnv("example.Genconstr.log");

      // Create initial model
      GRBModel model = new GRBModel(env);
      model.set(GRB.StringAttr.ModelName, "example.Genconstr");
      ...
      // Save problem
      model.write("example.Genconstr.mps");
      model.write("example.Genconstr.lp");
