...
/*
  example.Sudoku example.

  The example.Sudoku board is a 9x9 grid, which is further divided into a 3x3 grid
...
public class Sudoku {
  public static void main(String[] args) {
    ...
    if (args.length < 1) {
      System.out.println("Usage: java example.Sudoku filename");
      System.exit(1);
    }
